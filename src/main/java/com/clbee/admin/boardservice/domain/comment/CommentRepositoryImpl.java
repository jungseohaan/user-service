...
import com.clbee.admin.boardservice.api.comment.dto.QCommentListResponseDto;
import com.clbee.admin.userservice.domain.user.QUser;
...
import static com.clbee.admin.boardservice.domain.comment.QComment.comment;
import static com.clbee.admin.userservice.domain.user.QUser.user;

/**
 * com.clbee.admin.boardservice.domain.comment.CommentRepositoryImpl
 * <p>
 * 댓글 Querydsl 구현 클래스
 *
 * @author seohan jung
