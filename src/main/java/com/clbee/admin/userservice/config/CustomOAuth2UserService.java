...
import com.clbee.admin.userservice.config.dto.OAuthAttributes;
import com.clbee.admin.userservice.domain.user.User;
import com.clbee.admin.userservice.domain.user.UserRepository;
...
/**
 * com.clbee.admin.userservice.config.CustomOAuth2UserService
 * <p>
 ...
 *  2025/02/20    이백행        컨트리뷰션 이클립스 문제(Problems) 해결
 * </pre>
 */
