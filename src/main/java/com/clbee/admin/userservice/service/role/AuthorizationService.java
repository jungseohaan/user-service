...
import com.clbee.admin.userservice.api.role.dto.AuthorizationListResponseDto;
import com.clbee.admin.userservice.api.role.dto.AuthorizationResponseDto;
import com.clbee.admin.userservice.api.role.dto.AuthorizationSaveRequestDto;
import com.clbee.admin.userservice.api.role.dto.AuthorizationUpdateRequestDto;
import com.clbee.admin.userservice.domain.role.Authorization;
import com.clbee.admin.userservice.domain.role.AuthorizationRepository;
...
/**
 * com.clbee.admin.userservice.service.role.AuthorizationService
 * <p>
 * 인가 서비스 클래스
 *
 * @author seohan jung
...
public class AuthorizationService extends AbstractService {
    ...
    public Boolean isAuthorization(HttpServletRequest request, Authentication authentication) {
        ...
        return true; //isContainMatch(authorizationList, request.getMethod(), request.getRequestURI());
    }
